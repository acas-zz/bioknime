 ...
 */
public class StringMatcherNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.stringmatcher";

    // The shared instance.
    private static StringMatcherNodePlugin plugin;

    /**
     * The constructor.
     */
    public StringMatcherNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static StringMatcherNodePlugin getDefault() {
        return plugin;
    }
