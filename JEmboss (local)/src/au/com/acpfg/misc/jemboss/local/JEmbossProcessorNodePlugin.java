 ...
 */
public class JEmbossProcessorNodePlugin extends Plugin {
    // The shared instance.
    private static JEmbossProcessorNodePlugin plugin;

    /**
     * The constructor.
     */
    public JEmbossProcessorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static JEmbossProcessorNodePlugin getDefault() {
        return plugin;
    }
