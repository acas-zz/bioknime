 ...
 */
public class PhosphorylationScorerNodePlugin extends Plugin {
    // The shared instance.
    private static PhosphorylationScorerNodePlugin plugin;

    /**
     * The constructor.
     */
    public PhosphorylationScorerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PhosphorylationScorerNodePlugin getDefault() {
        return plugin;
    }
