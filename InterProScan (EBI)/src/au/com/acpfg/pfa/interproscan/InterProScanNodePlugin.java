 ...
 */
public class InterProScanNodePlugin extends Plugin {
    // The shared instance.
    private static InterProScanNodePlugin plugin;

    /**
     * The constructor.
     */
    public InterProScanNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static InterProScanNodePlugin getDefault() {
        return plugin;
    }
