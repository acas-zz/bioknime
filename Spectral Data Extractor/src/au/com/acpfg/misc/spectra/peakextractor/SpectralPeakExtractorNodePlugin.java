 ...
 */
public class SpectralPeakExtractorNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.spectra.peakextractor";

    // The shared instance.
    private static SpectralPeakExtractorNodePlugin plugin;

    /**
     * The constructor.
     */
    public SpectralPeakExtractorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SpectralPeakExtractorNodePlugin getDefault() {
        return plugin;
    }
