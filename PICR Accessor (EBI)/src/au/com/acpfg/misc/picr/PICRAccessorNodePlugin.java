 ...
 */
public class PICRAccessorNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.picr";

    // The shared instance.
    private static PICRAccessorNodePlugin plugin;

    /**
     * The constructor.
     */
    public PICRAccessorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PICRAccessorNodePlugin getDefault() {
        return plugin;
    }
