    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(uk.ac.ebi.picr.AccessionMapperService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = uk.ac.ebi.picr.AccessionMapperService.class.getResource(".");
    ...
    public AccessionMapperInterface getAccessionMapperPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.ebi.ac.uk/picr/AccessionMappingService", "AccessionMapperPort"), AccessionMapperInterface.class, features);
    }
