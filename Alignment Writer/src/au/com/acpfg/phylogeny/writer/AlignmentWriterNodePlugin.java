 ...
 */
public class AlignmentWriterNodePlugin extends Plugin {
    // The shared instance.
    private static AlignmentWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public AlignmentWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static AlignmentWriterNodePlugin getDefault() {
        return plugin;
    }
