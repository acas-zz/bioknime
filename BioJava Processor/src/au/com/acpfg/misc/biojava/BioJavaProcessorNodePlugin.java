 ...
 */
public class BioJavaProcessorNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.biojavamanipulator";

    // The shared instance.
    private static BioJavaProcessorNodePlugin plugin;

    /**
     * The constructor.
     */
    public BioJavaProcessorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BioJavaProcessorNodePlugin getDefault() {
        return plugin;
    }
