 ...
 */
public class MuscleAlignerNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.align.muscle";

    // The shared instance.
    private static MuscleAlignerNodePlugin plugin;

    /**
     * The constructor.
     */
    public MuscleAlignerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MuscleAlignerNodePlugin getDefault() {
        return plugin;
    }
