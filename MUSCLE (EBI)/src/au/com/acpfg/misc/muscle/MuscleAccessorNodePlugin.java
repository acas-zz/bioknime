 ...
 */
public class MuscleAccessorNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.muscle";

    // The shared instance.
    private static MuscleAccessorNodePlugin plugin;

    /**
     * The constructor.
     */
    public MuscleAccessorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MuscleAccessorNodePlugin getDefault() {
        return plugin;
    }
