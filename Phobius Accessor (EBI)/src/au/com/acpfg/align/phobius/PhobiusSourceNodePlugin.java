 ...
 */
public class PhobiusSourceNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.align.phobius";

    // The shared instance.
    private static PhobiusSourceNodePlugin plugin;

    /**
     * The constructor.
     */
    public PhobiusSourceNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PhobiusSourceNodePlugin getDefault() {
        return plugin;
    }
