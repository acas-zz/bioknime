 ...
 */
public class SpectraWriterNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.spectra.writer";

    // The shared instance.
    private static SpectraWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public SpectraWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SpectraWriterNodePlugin getDefault() {
        return plugin;
    }
