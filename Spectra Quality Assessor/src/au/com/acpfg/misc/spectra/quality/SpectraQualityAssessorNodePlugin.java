 ...
 */
public class SpectraQualityAssessorNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.spectra.quality";

    // The shared instance.
    private static SpectraQualityAssessorNodePlugin plugin;

    /**
     * The constructor.
     */
    public SpectraQualityAssessorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SpectraQualityAssessorNodePlugin getDefault() {
        return plugin;
    }
