 ...
 */
public class WUBlastNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.blast.wublast";

    // The shared instance.
    private static WUBlastNodePlugin plugin;

    /**
     * The constructor.
     */
    public WUBlastNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static WUBlastNodePlugin getDefault() {
        return plugin;
    }
