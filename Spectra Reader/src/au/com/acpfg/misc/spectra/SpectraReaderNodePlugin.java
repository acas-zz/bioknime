 ...
 */
public class SpectraReaderNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "au.com.acpfg.misc.spectra";

    // The shared instance.
    private static SpectraReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public SpectraReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SpectraReaderNodePlugin getDefault() {
        return plugin;
    }
